...
scotchApp.controller('search_customerController', function ($rootScope, $scope, $http, $routeParams, $location, $filter, $cookieStore) {
    ...
    //Requested Customer
    $http.get(linkglobal + '/CustomerAccounts?$filter=bank_id eq ' + imageIDData + ' and is_sync ne false' + ' and trx_type ne 3').success(function (response) { var cust1 = response; var cust2 = cust1.value; $scope.customers = cust2; var count = cust2.length; });
