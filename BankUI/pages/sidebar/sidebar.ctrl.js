...
scotchApp.controller('sidebarController', function ($rootScope, $scope, $http, $routeParams, $location, $filter, $cookieStore,$interval, $timeout) {
    ...
    //addBank
    $scope.addBank = function () { $location.path('/bank'); }

    //addAdmin
    $scope.addAdmin = function () { $location.path('/admin'); }

    //viewbankList
    $scope.viewbankList = function () { $location.path('/viewBankList'); }

    //Dashboard
    $scope.viewAdminList = function () { $location.path('/viewAdminList'); }

    //Admin(add product)
    $scope.addProduct = function () { $location.path('/Product'); }

    $scope.addBranch = function () {$location.path('/branch');}

    $scope.viewbranchList = function () { $location.path('/viewBranchList'); }

    $scope.viewProductList = function () { $location.path('/viewProductList'); }
