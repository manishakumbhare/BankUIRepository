...
var scotchApp = angular.module('app.Product', ['ngRoute'])


scotchApp.controller('ProductController', function ($rootScope, $scope, $http, $routeParams, $location, $filter, $cookieStore, $interval, $timeout) {
