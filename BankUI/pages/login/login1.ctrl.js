...
var app = angular.module('app.login1', ['ngRoute', 'ngCookies']);
 
// create the controller and inject Angular's $scope
app.controller('loginController1', function ($rootScope, $scope, $http, $location, $routeParams, $filter, $cookieStore) {
